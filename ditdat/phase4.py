...
def get_output_dir(project_dir, args):
    ...
    return os.path.join(project_dir, f"transcripts_{args.suffix}")
...
if __name__ == "__main__":
    _parser = argparse.ArgumentParser(description="FASE 4 - Trascrizione con Whisper (segmenti separati)")
